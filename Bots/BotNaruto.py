...
class BotNaruto(Bot):
    def __init__(self, nome, urlJSON):
        ...
        self.comandos = [Comando(0, "Rasengan", ["AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA RASENGAAAAAAAAAANNNN!"]), Comando(1, "Motivacional", ["O Naruto pode ser um pouco duro às vezes, talvez você não saiba disso, \n mas o Naruto também cresceu sem pai. Na verdade ele nunca conheceu nenhum de seus pais,\n e nunca teve nenhum amigo em nossa aldeia."]),
